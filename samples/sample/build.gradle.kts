...
android {
    ...
    defaultConfig {
        ...
        versionCode = 1
        // Taken from the project, not typed again: two numbers meaning the same
        // release drift apart in silence, and this one is visible in the APK.
        versionName = version.toString().removeSuffix("-SNAPSHOT")
