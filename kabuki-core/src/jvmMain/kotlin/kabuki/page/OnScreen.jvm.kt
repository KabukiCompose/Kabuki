...
/**
 * JVM: an `object` screen is taken as it is, a class is created through its
 * no-arg constructor. If the test module is minified, keep those constructors -
 * see `consumer-rules.pro`.
 */
